...
//
//import com.bubble.thrift.RecommendServiceClient;
//import com.bubble.dao.ScoreRecordService;
//import com.bubble.dao.UserBaseService;
//import com.bubble.dao.UserInfoService;
...
//        }
//
////    @GetMapping(value = "/getItemBaseList")
////    public List<ItemBase> getItemBaseList() throws Exception {
////        return itemBaseService.batchGetItemBase(1,10);
////    }
//
//        @GetMapping(value = "/syncItemBase")
//        public String syncItemBase() throws Exception {
//            RecommendServiceClient recommendServiceClient = new RecommendServiceClient();
//            System.out.println(recommendServiceClient.toString());
//            Boolean result = recommendServiceClient.SyncItemBase();
